...
public class AppCore {
    ...
    //TODO
    //1) check functionality of marked methods
    ...
    public static Response handle(EntityManager em, Request req) throws SQLException, NoSuchRequestException {
        ...
        if (req.getAccTitle() != null) {
            if (!req.getAccTitle().substring(0, Account.getBankID().length()).equals(Account.getBankID())) {
    ...
    private static Response login(EntityManager em, Request req) throws SQLException {
        ...
        if (!userExists(em, req.getUserID())) {
            ...
            } else if (req.getUsername() == null || !user.getUserName().equals(req.getUsername())) {
    ...
    private static Response checkBalance(EntityManager em, Request req) {
        ...
        if (!userExists(em, req.getUserID())) {
            ...
            if (acc == null) {
                ...
                response.setResponseMessage("Current balance on account \"" + acc.getTitle().substring(Account.getBankID().length()) + "\" is " + acc.getBalance());
            }
        }
        return response;
    }
    ...
    public static void main(String[] args) throws NoSuchRequestException {

        Request req11 = new Request(RequestType.REGISTER, "0123456789", "Peter", "SpiderVan");
        //Request req12 = new Request(RequestType.REGISTER, "0123456789", "Peter", "SpiderVan", "parker_account", 100);
        ...
        //Request req52 = new Request(RequestType.CHECK_BALANCE, "0123456789", "parker_account2"); //no such account (delete it dirst)
        ...
        //Request req62 = new Request(RequestType.ADD_FUNDS, null, "parker_account3", 50);
		...
		*/
        ...
        Response resp2 = handleRequest(req11);
